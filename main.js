...
function populateProducts(productList) {
    ...
    let produtcsSection = document.querySelector(".products-area");
    produtcsSection.textContent = "";

    // Run a loop through the products and create an HTML element ("product-item") for each of them
    productList.forEach(function(product, index){

        // Create the HTML element for the in
        ...
        // Add complete individul product to the section
        produtcsSection.append(productElm);
